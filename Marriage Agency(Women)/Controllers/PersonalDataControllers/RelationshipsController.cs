...
namespace Marriage_Agency_Women_.Controllers.PersonalDataControllers
{
    ...
    public class RelationshipsController : Controller
    {
        ...
        {
            return View(db.Relationships.ToList().OrderBy(r => r.Position));
        }
        ...
        public ActionResult Create([Bind(Include = "Id,Position,RussianName,EnglishName,JapaneseName")] Relationship relationship)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Position,RussianName,EnglishName,JapaneseName")] Relationship relationship)
        {
            if (ModelState.IsValid)
            {
        ...
        {
            Relationship relationship = db.Relationships.Find(id);
            var users = db.Users.Where(u => u.Relationship.RussianName == relationship.RussianName);
